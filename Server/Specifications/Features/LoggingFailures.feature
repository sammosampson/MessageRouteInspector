...
Scenario: One route from correlated message then failure
	Given I have logged command processing for the message 'first' from machine 'TestMachine1' on thread 1 dated '09/21/1975 00:00:01' with correlation id '{2A0997AC-BFB0-42C8-8FF7-32F637D4DB9A}'
	And I have logged a failure with the name 'massiveException' from machine 'TestMachine2' on thread 1 dated '09/21/1975 00:00:02' with correlation id '{2A0997AC-BFB0-42C8-8FF7-32F637D4DB9A}'
	And I wait for the message named 'massiveException' to be populated on the route in the view
    When I get all routes
	Then there should only be one route
	And there should a message at index 0 of the route's messages
