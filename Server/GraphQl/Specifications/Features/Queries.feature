...
Scenario: Getting routes with one route with a command processing but not processed
	...
	Then I should be returned 
"""
{"data":{"viewer":{"routes":[{"createdOn":"2015-12-31 09:16:31","machine":"CSAMPSON1700"}]}}}
"""
...
Scenario: Getting routes with one route with a command processing and processed
	...
	Then I should be returned 
"""
{"data":{"viewer":{"routes":[{"createdOn":"2015-12-31 09:16:31","machine":"CSAMPSON1700","root":{"name":"X","type":0,"closeBranchCount":1},"messages":[{"name":"X"}]}]}}}
"""
...
Scenario: Getting routes with one route with an event processing and processed
	...
	Then I should be returned 
"""
{"data":{"viewer":{"routes":[{"createdOn":"2015-12-31 09:16:31","machine":"CSAMPSON1700","root":{"name":"X","type":1,"closeBranchCount":1},"messages":[{"name":"X"}]}]}}}
"""
...
Scenario: Getting routes with a failure
	...
	Then I should be returned 
"""
{"data":{"viewer":{"routes":[{"createdOn":"2015-12-31 09:16:31","machine":"CSAMPSON1700","root":{"name":"X","type":0,"closeBranchCount":0},"messages":[{"name":"X","type":0},{"name":"A failure","type":2}]}]}}}
"""
...
Scenario: Getting routes using fragments
	...
	Then I should be returned 
"""
{"data":{"viewer":{"routes":[{"createdOn":"2015-12-31 09:16:31"}]}}}
"""
